    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          _buildContactRow(Icons.email, 'support@sisaket-travel.com'),
          SizedBox(height: 8),
          _buildContactRow(Icons.phone, '045-123-456'),
          SizedBox(height: 8),
          _buildContactRow(Icons.location_on, 'ศาลากลางจังหวัดศรีสะเกษ'),
        ],
      ),
    );
  }
